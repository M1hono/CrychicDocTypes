...
declare namespace Internal {
    ...
    class ConstructParameterTypes extends Internal.Enum<Internal.ConstructParameterTypes> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getDeclaringClass(): typeof Internal.ConstructParameterTypes;
        getClass(): typeof any;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.ConstructParameterTypes>>;
        toString(): string;
        compareTo(arg0: Internal.ConstructParameterTypes_): number;
        notifyAll(): void;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        ...
        name(): string;
        hashCode(): number;
        static valueOf(arg0: string): Internal.ConstructParameterTypes;
        ordinal(): number;
        wait(): void;
        wait(arg0: number): void;
        static values(): Internal.ConstructParameterTypes[];
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        "compareTo(com.mna.api.entities.construct.ai.parameter.ConstructParameterTypes)"(arg0: Internal.ConstructParameterTypes_): number;
        get declaringClass(): typeof Internal.ConstructParameterTypes
        get class(): typeof any
        static readonly BOOLEAN: (Internal.ConstructParameterTypes) & (Internal.ConstructParameterTypes);
        static readonly POINT: (Internal.ConstructParameterTypes) & (Internal.ConstructParameterTypes);
        static readonly FILTER: (Internal.ConstructParameterTypes) & (Internal.ConstructParameterTypes);
        static readonly ITEMSTACK: (Internal.ConstructParameterTypes) & (Internal.ConstructParameterTypes);
        static readonly INTEGER: (Internal.ConstructParameterTypes) & (Internal.ConstructParameterTypes);
        static readonly AREA: (Internal.ConstructParameterTypes) & (Internal.ConstructParameterTypes);
    }
    type ConstructParameterTypes_ = "filter" | "area" | "itemstack" | "boolean" | "point" | ConstructParameterTypes | "integer";
    interface BackpackModelItem {
        abstract getModelTexture(arg0: Internal.ItemStack_): ResourceLocation;
        (arg0: Internal.ItemStack): ResourceLocation_;
    }
    type BackpackModelItem_ = BackpackModelItem | ((arg0: Internal.ItemStack)=> ResourceLocation_);
    ...
    class PalletBlock extends Internal.HorizontalDirectionalBlock implements Internal.SimpleWaterloggedBlock {
        ...
        */
        ...
        static readonly LAYER_2: (Internal.BooleanProperty) & (Internal.BooleanProperty);
        static readonly LAYER_1: (Internal.BooleanProperty) & (Internal.BooleanProperty);
    }
    type PalletBlock_ = PalletBlock;
    ...
    abstract class ItemBuilder extends Internal.BuilderBase<Internal.Item> {
        ...
        */
        ...
        attachCapability(builder: Internal.CapabilityBuilder_<any, any, any>): this;
    ...
    class Fireproof extends Internal.MAEnchantmentBase {
        constructor()
        getClass(): typeof any;
    ...
    class ColorSpace$Model extends Internal.Enum<Internal.ColorSpace$Model> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        static values(): Internal.ColorSpace$Model[];
        toString(): string;
        getDeclaringClass(): typeof Internal.ColorSpace$Model;
        notifyAll(): void;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.ColorSpace$Model>>;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        "compareTo(icyllis.arc3d.core.ColorSpace$Model)"(arg0: Internal.ColorSpace$Model_): number;
        name(): string;
        hashCode(): number;
        compareTo(arg0: Internal.ColorSpace$Model_): number;
        ordinal(): number;
        wait(): void;
        wait(arg0: number): void;
        ...
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        static valueOf(name: string): Internal.ColorSpace$Model;
        get class(): typeof any
        get declaringClass(): typeof Internal.ColorSpace$Model
        get componentCount(): number
        static readonly XYZ: (Internal.ColorSpace$Model) & (Internal.ColorSpace$Model);
        static readonly RGB: (Internal.ColorSpace$Model) & (Internal.ColorSpace$Model);
        static readonly LAB: (Internal.ColorSpace$Model) & (Internal.ColorSpace$Model);
        static readonly CMYK: (Internal.ColorSpace$Model) & (Internal.ColorSpace$Model);
    }
    type ColorSpace$Model_ = ColorSpace$Model | "rgb" | "lab" | "xyz" | "cmyk";
    ...
    class RectF {
        constructor()
        constructor(r: Internal.RectF_)
        constructor(r: Internal.Rect_)
        constructor(left: number, top: number, right: number, bottom: number)
        getClass(): typeof any;
        contains(r: Internal.RectF_): boolean;
        "set(icyllis.modernui.graphics.RectF)"(src: Internal.RectF_): void;
        width(): number;
        intersect(left: number, top: number, right: number, bottom: number): boolean;
        set(src: Internal.RectF_): void;
        sort(): void;
        height(): number;
        isEmpty(): boolean;
        notify(): void;
        ...
        setEmpty(): void;
        isFinite(): boolean;
        static copy(r: Internal.RectF_): Internal.RectF;
        static intersects(a: Internal.RectF_, b: Internal.RectF_): boolean;
        set(left: number, top: number, right: number, bottom: number): void;
        roundOut(dst: Internal.Rect_): void;
        centerX(): number;
        union(r: Internal.RectF_): void;
        centerY(): number;
        setIntersect(a: Internal.RectF_, b: Internal.RectF_): boolean;
        "set(icyllis.modernui.graphics.Rect)"(src: Internal.Rect_): void;
        toString(): string;
        isSorted(): boolean;
        notifyAll(): void;
        ...
        hashCode(): number;
        intersect(r: Internal.RectF_): boolean;
        set(src: Internal.Rect_): void;
        wait(): void;
        contains(left: number, top: number, right: number, bottom: number): boolean;
        wait(arg0: number): void;
        transform(m: icyllis.modernui.graphics.Matrix_): void;
        equals(o: any): boolean;
        offsetTo(newLeft: number, newTop: number): void;
        get class(): typeof any
        set "(icyllis.modernui.graphics.RectF)"(src: Internal.RectF_)
        get empty(): boolean
        get finite(): boolean
        set "(icyllis.modernui.graphics.Rect)"(src: Internal.Rect_)
        get sorted(): boolean
        right: number;
        top: number;
        left: number;
    ...
    type RectF_ = RectF;
    abstract class AbstractRecipeJSBuilder <T extends Internal.IRecipeBuilder<Internal.Recipe<any>>> extends Internal.RecipeJS implements Internal.RecipeJSBuilder {
        constructor(typeID: ResourceLocation_)
        /**
         * @deprecated
        */
        getGroup(): string;
        ...
        addRequirement(requirement: Internal.IRequirement_<any>): this;
        remove(): void;
        ...
        info(consumer: Internal.Consumer_<Internal.DisplayInfoTemplate>): this;
        ...
        */
        ...
        static readonly IDS: ({}) & (Internal.Map<ResourceLocation, Internal.Map<ResourceLocation, number>>);
    }
    type AbstractRecipeJSBuilder_<T extends Internal.IRecipeBuilder<Internal.Recipe<any>>> = AbstractRecipeJSBuilder<T>;
    ...
    class MobEntityJS extends Internal.PathfinderMob implements Internal.IAnimatableJS, Internal.RangedAttackMob {
        constructor(builder: Internal.MobEntityJSBuilder_, pEntityType: Internal.EntityType_<Internal.PathfinderMob>, pLevel: Internal.Level_)
    ...
    interface EntityAttributeInstanceInvoker {
        abstract invokeGetModifiersByOperation(arg0: Internal.AttributeModifier$Operation_): Internal.Collection<Internal.AttributeModifier>;
        (arg0: Internal.AttributeModifier$Operation): Internal.Collection_<Internal.AttributeModifier>;
    }
    type EntityAttributeInstanceInvoker_ = EntityAttributeInstanceInvoker | ((arg0: Internal.AttributeModifier$Operation)=> Internal.Collection_<Internal.AttributeModifier>);
    ...
    class EldrinAltarBlock extends com.mna.blocks.runeforging.PedestalBlock implements Internal.EntityBlock {
        constructor()
        /**
         * @deprecated
        */
    ...
    type EldrinAltarBlock_ = EldrinAltarBlock;
    ...
    abstract class WaterloggableBlock extends Internal.Block implements Internal.SimpleWaterloggedBlock {
    ...
    abstract class AbstractPonderBuilder <S extends Internal.AbstractPonderBuilder<S>> {
        ...
        notifyAll(): void;
        wait(arg0: number): void;
        tag(...arg0: Internal.PonderTag_[]): S;
        equals(arg0: any): boolean;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        get class(): typeof any
    }
    type AbstractPonderBuilder_<S extends Internal.AbstractPonderBuilder<S>> = AbstractPonderBuilder<S>;
    ...
    class LightPylonBlock extends Internal.PylonBlock {
    ...
    type LightPylonBlock_ = LightPylonBlock;
    ...
    interface ZombImmunizableEntity {
        abstract fabrication$isZombImmune(): boolean;
        abstract fabrication$setZombImmune(arg0: boolean): void;
    }
    type ZombImmunizableEntity_ = ZombImmunizableEntity;
    ...
    class MagneticNodeFeatureConfiguration implements Internal.FeatureConfiguration {
        ...
        static readonly CODEC: Internal.Codec<Internal.MagneticNodeFeatureConfiguration>;
        readonly nodeBlock: Internal.BlockStateProvider;
        readonly pillarBlock: Internal.BlockStateProvider;
    }
    type MagneticNodeFeatureConfiguration_ = MagneticNodeFeatureConfiguration;
    ...
    interface SingletonBlockMethod extends Internal.BlockMethod {
    }
    type SingletonBlockMethod_ = SingletonBlockMethod;
    class OffsetPlacerItem extends Internal.TieredBlockItem {
        constructor(arg0: Internal.Block_, arg1: Internal.Item$Properties_, arg2: Internal.Function_<Internal.BlockPlaceContext, Internal.BlockPlaceContext>)
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
        isEnderMask(arg0: Internal.ItemStack_, arg1: Internal.Player_, arg2: Internal.EnderMan_): boolean;
    ...
    type OffsetPlacerItem_ = OffsetPlacerItem;
    ...
    class LevelChunkTicks <T> implements Internal.TickContainerAccess<T>, Internal.SerializableTickContainer<T> {
        ...
        getClass(): typeof any;
        count(): number;
        hasScheduledTick(arg0: BlockPos_, arg1: any): boolean;
        schedule(arg0: Internal.ScheduledTick_<any>): void;
        ...
        notify(): void;
        removeIf(arg0: Internal.Predicate_<any>): void;
        wait(arg0: number, arg1: number): void;
        unpack(arg0: number): void;
        hashCode(): number;
        wait(): void;
        save(arg0: number, arg1: Internal.Function_<any, any>): Internal.ListTag;
        wait(arg0: number): void;
    ...
    class ShapedText {
        constructor(text: string[], contextStart: number, contextLimit: number, start: number, limit: number, bidiFlags: number, paint: Internal.FontPaint_)
        getAdvances(): number[];
        getClass(): typeof any;
        getGlyphs(): number[];
        getAdvance(): number;
        ...
        getGlyph(i: number): number;
        getFont(i: number): icyllis.modernui.graphics.text.Font;
        static doLayoutRun(text: string[], contextStart: number, contextLimit: number, start: number, limit: number, isRtl: boolean, paint: Internal.FontPaint_, layoutStart: number, advances: number[], curAdvance: number, glyphs: Internal.IntArrayList_, positions: Internal.FloatArrayList_, fontIndices: Internal.ByteArrayList_, idGet: Internal.Function_<icyllis.modernui.graphics.text.Font, number>, extent: Internal.FontMetricsInt_, consumer: Internal.ShapedText$RunConsumer_): number;
        getGlyphCount(): number;
        getMemoryUsage(): number;
        toString(): string;
        notifyAll(): void;
        getAdvance(i: number): number;
        getDescent(): number;
        hashCode(): number;
        wait(): void;
        static doLayoutRun(text: string[], contextStart: number, contextLimit: number, start: number, limit: number, isRtl: boolean, paint: Internal.FontPaint_, extent: Internal.FontMetricsInt_, consumer: Internal.ShapedText$RunConsumer_): number;
        wait(arg0: number): void;
        getPositions(): number[];
        equals(arg0: any): boolean;
        get advances(): number[]
        ...
        static readonly BIDI_DEFAULT_LTR: (2) & (number);
        static readonly BIDI_LTR: (0) & (number);
        static readonly BIDI_DEFAULT_RTL: (3) & (number);
        static readonly BIDI_OVERRIDE_LTR: (4) & (number);
        static readonly BIDI_RTL: (1) & (number);
        static readonly BIDI_OVERRIDE_RTL: (5) & (number);
    }
    type ShapedText_ = ShapedText;
    ...
    type SpawnPlacements$Type_ = "in_lava" | "on_ground" | "in_water" | "no_restrictions" | SpawnPlacements$Type | "mmspawn" | "in_acid";
    abstract class AbstractHugeMushroomFeature extends Feature<Internal.HugeMushroomFeatureConfiguration> {
    ...
    interface IJEIIngredientRequirement <T> {
        abstract getJEIIngredientWrappers(arg0: Internal.IMachineRecipe_): Internal.List<Internal.IJEIIngredientWrapper<T>>;
        (arg0: Internal.IMachineRecipe): Internal.List_<Internal.IJEIIngredientWrapper<T>>;
    }
    type IJEIIngredientRequirement_<T> = IJEIIngredientRequirement<T> | ((arg0: Internal.IMachineRecipe)=> Internal.List_<Internal.IJEIIngredientWrapper<T>>);
    ...
    class WoodenWallBlock extends Internal.WallBlock {
        constructor(arg0: Internal.BlockBehaviour$Properties_)
        /**
         * @deprecated
        */
    ...
    type WoodenWallBlock_ = WoodenWallBlock;
    class SceneBuildingUtil {
        getClass(): typeof any;
        hashCode(): number;
        toString(): string;
        wait(): void;
    ...
    class RecipeChecker <T extends Internal.IMachineRecipe> {
        constructor(recipe: T)
        getClass(): typeof any;
        isInventoryRequirementsOnly(): boolean;
        check(tile: Internal.MachineTile_, context: Internal.ICraftingContext_, inventoryChanged: boolean): boolean;
        toString(): string;
        notifyAll(): void;
        isInventoryRequirementsOk(): boolean;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        hashCode(): number;
        getRecipe(): T;
    ...
    type RecipeChecker_<T extends Internal.IMachineRecipe> = RecipeChecker<T>;
}
declare namespace icyllis.modernui.view {
    class KeyEvent extends icyllis.modernui.view.InputEvent {
        getClass(): typeof any;
        startTracking(): void;
        ...
        recycle(): void;
        static obtain(eventTime: number, action: number, code: number, repeat: number, modifiers: number, scancode: number, flags: number): icyllis.modernui.view.KeyEvent;
        wait(): void;
        static isModifierKey(keyCode: number): boolean;
        wait(arg0: number): void;
        equals(arg0: any): boolean;
        ...
        static readonly KEY_F16: (305) & (number);
        static readonly KEY_T: (84) & (number);
        static readonly KEY_F20: (309) & (number);
        static readonly KEY_3: (51) & (number);
        static readonly KEY_UNKNOWN: (-1) & (number);
        static readonly KEY_RIGHT_ALT: (346) & (number);
        static readonly FLAG_TRACKING: (512) & (number);
        static readonly ACTION_DOWN: (0) & (number);
        static readonly KEY_MENU: (348) & (number);
        static readonly KEY_K: (75) & (number);
        static readonly KEY_RIGHT_CONTROL: (345) & (number);
        static readonly FLAG_PREDISPATCH: (536870912) & (number);
        static readonly KEY_F8: (297) & (number);
        static readonly KEY_KP_4: (324) & (number);
        static readonly FLAG_FALLBACK: (1024) & (number);
        static readonly KEY_LEFT_SHIFT: (340) & (number);
        static readonly KEY_C: (67) & (number);
        static readonly KEY_F17: (306) & (number);
        static readonly KEY_KP_ENTER: (335) & (number);
        static readonly KEY_APOSTROPHE: (39) & (number);
        static readonly FLAG_SOFT_KEYBOARD: (2) & (number);
        static readonly KEY_F21: (310) & (number);
        static readonly KEY_2: (50) & (number);
        static readonly KEY_S: (83) & (number);
        static readonly KEY_EQUAL: (61) & (number);
        static readonly KEY_LEFT_ALT: (342) & (number);
        static readonly KEY_RIGHT_SHIFT: (344) & (number);
        static readonly KEY_J: (74) & (number);
        static readonly KEY_END: (269) & (number);
        static readonly KEY_BACKSLASH: (92) & (number);
        static readonly KEY_COMMA: (44) & (number);
        static readonly KEY_F9: (298) & (number);
        static readonly KEY_KP_3: (323) & (number);
        static readonly KEY_LEFT_CONTROL: (341) & (number);
        static readonly KEY_B: (66) & (number);
        static readonly KEY_SEMICOLON: (59) & (number);
        static readonly KEY_MINUS: (45) & (number);
        static readonly KEY_SCROLL_LOCK: (281) & (number);
        static readonly KEY_F14: (303) & (number);
        static readonly KEY_9: (57) & (number);
        static readonly KEY_F5: (294) & (number);
        static readonly KEY_KP_MULTIPLY: (332) & (number);
        static readonly KEY_Z: (90) & (number);
        static readonly KEY_KP_SUBTRACT: (333) & (number);
        static readonly FLAG_START_TRACKING: (1073741824) & (number);
        static readonly KEY_1: (49) & (number);
        static readonly KEY_R: (82) & (number);
        static readonly KEY_PERIOD: (46) & (number);
        static readonly KEY_I: (73) & (number);
        static readonly KEY_PAUSE: (284) & (number);
        static readonly FLAG_EDITOR_ACTION: (16) & (number);
        static readonly KEY_F6: (295) & (number);
        static readonly KEY_A: (65) & (number);
        static readonly KEY_KP_6: (326) & (number);
        static readonly FLAG_VIRTUAL_HARD_KEY: (64) & (number);
        static readonly KEY_8: (56) & (number);
        static readonly KEY_Y: (89) & (number);
        static readonly KEY_KP_DECIMAL: (330) & (number);
        static readonly KEY_F15: (304) & (number);
        static readonly KEY_KP_DIVIDE: (331) & (number);
        static readonly KEY_RIGHT_SUPER: (347) & (number);
        static readonly KEY_KP_EQUAL: (336) & (number);
        static readonly ACTION_UP: (1) & (number);
        static readonly KEY_0: (48) & (number);
        static readonly KEY_Q: (81) & (number);
        static readonly KEY_KP_ADD: (334) & (number);
        static readonly KEY_SPACE: (32) & (number);
        static readonly FLAG_CANCELED_LONG_PRESS: (256) & (number);
        static readonly KEY_H: (72) & (number);
        static readonly KEY_PAGE_UP: (266) & (number);
        static readonly KEY_KP_5: (325) & (number);
        static readonly KEY_LEFT_BRACKET: (91) & (number);
        static readonly KEY_F7: (296) & (number);
        static readonly KEY_PAGE_DOWN: (267) & (number);
        static readonly KEY_X: (88) & (number);
        static readonly KEY_F24: (313) & (number);
        static readonly KEY_F3: (292) & (number);
        static readonly KEY_F12: (301) & (number);
        static readonly KEY_7: (55) & (number);
        static readonly KEY_P: (80) & (number);
        static readonly KEY_PRINT_SCREEN: (283) & (number);
        static readonly KEY_RIGHT: (262) & (number);
        static readonly KEY_O: (79) & (number);
        static readonly KEY_KP_0: (320) & (number);
        static readonly FLAG_CANCELED: (32) & (number);
        static readonly KEY_BACKSPACE: (259) & (number);
        static readonly KEY_G: (71) & (number);
        static readonly KEY_RIGHT_BRACKET: (93) & (number);
        static readonly KEY_LEFT: (263) & (number);
        static readonly KEY_KP_8: (328) & (number);
        static readonly KEY_DOWN: (264) & (number);
        static readonly KEY_F4: (293) & (number);
        static readonly KEY_F25: (314) & (number);
        static readonly KEY_F13: (302) & (number);
        static readonly FLAG_FROM_SYSTEM: (8) & (number);
        static readonly KEY_WORLD_2: (162) & (number);
        static readonly KEY_GRAVE_ACCENT: (96) & (number);
        static readonly KEY_6: (54) & (number);
        static readonly KEY_W: (87) & (number);
        static readonly KEY_INSERT: (260) & (number);
        static readonly KEY_SLASH: (47) & (number);
        static readonly KEY_N: (78) & (number);
        static readonly KEY_TAB: (258) & (number);
        static readonly KEY_LEFT_SUPER: (343) & (number);
        static readonly META_SHIFT_ON: (1) & (number);
        static readonly KEY_F: (70) & (number);
        static readonly KEY_NUM_LOCK: (282) & (number);
        static readonly KEY_KP_7: (327) & (number);
        static readonly KEY_F18: (307) & (number);
        static readonly KEY_F1: (290) & (number);
        static readonly KEY_WORLD_1: (161) & (number);
        static readonly KEY_ESCAPE: (256) & (number);
        static readonly KEY_F10: (299) & (number);
        static readonly KEY_5: (53) & (number);
        static readonly KEY_V: (86) & (number);
        static readonly KEY_F22: (311) & (number);
        static readonly META_SUPER_ON: (8) & (number);
        static readonly KEY_M: (77) & (number);
        static readonly KEY_UP: (265) & (number);
        static readonly KEY_HOME: (268) & (number);
        static readonly META_CTRL_ON: (2) & (number);
        static readonly FLAG_LONG_PRESS: (128) & (number);
        static readonly KEY_E: (69) & (number);
        static readonly KEY_DELETE: (261) & (number);
        static readonly KEY_KP_2: (322) & (number);
        static readonly KEY_CAPS_LOCK: (280) & (number);
        static readonly KEY_F19: (308) & (number);
        static readonly KEY_F2: (291) & (number);
        static readonly FLAG_KEEP_TOUCH_MODE: (4) & (number);
        static readonly KEY_4: (52) & (number);
        static readonly KEY_U: (85) & (number);
        static readonly KEY_F23: (312) & (number);
        static readonly KEY_F11: (300) & (number);
        static readonly META_ALT_ON: (4) & (number);
        static readonly KEY_L: (76) & (number);
        static readonly KEY_KP_1: (321) & (number);
        static readonly KEY_ENTER: (257) & (number);
        static readonly KEY_D: (68) & (number);
        static readonly KEY_KP_9: (329) & (number);
    }
...
declare namespace com.mna.api.items {
    class TieredItem extends Internal.Item implements Internal.ITieredItem<com.mna.api.items.TieredItem> {
        constructor(arg0: Internal.Item$Properties_)
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
