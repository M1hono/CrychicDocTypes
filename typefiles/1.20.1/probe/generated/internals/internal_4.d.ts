...
declare namespace Internal {
    ...
    interface SetFabricationConfigAware {
        abstract fabrication$getReqVer(): number;
        abstract fabrication$setReqVer(arg0: number): void;
    }
    type SetFabricationConfigAware_ = SetFabricationConfigAware;
    ...
    class LevelChunk extends Internal.ChunkAccess implements Internal.LevelHeightAccessor, Internal.WorldChunkAccessor, Internal.ICapabilityProviderImpl<Internal.LevelChunk> {
    ...
    class SpawnParticleEffectMessage$ParticleTypes extends Internal.Enum<Internal.SpawnParticleEffectMessage$ParticleTypes> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        toString(): string;
        "compareTo(com.mna.network.messages.to_client.SpawnParticleEffectMessage$ParticleTypes)"(arg0: Internal.SpawnParticleEffectMessage$ParticleTypes_): number;
        static values(): Internal.SpawnParticleEffectMessage$ParticleTypes[];
        notifyAll(): void;
        compareTo(arg0: Internal.SpawnParticleEffectMessage$ParticleTypes_): number;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.SpawnParticleEffectMessage$ParticleTypes>>;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        name(): string;
        getDeclaringClass(): typeof Internal.SpawnParticleEffectMessage$ParticleTypes;
        hashCode(): number;
        static valueOf(arg0: string): Internal.SpawnParticleEffectMessage$ParticleTypes;
        ordinal(): number;
        wait(): void;
        wait(arg0: number): void;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        get class(): typeof any
        get declaringClass(): typeof Internal.SpawnParticleEffectMessage$ParticleTypes
        static readonly CONSTRUCT_AXE_SMASH: (Internal.SpawnParticleEffectMessage$ParticleTypes) & (Internal.SpawnParticleEffectMessage$ParticleTypes);
        static readonly CONSTRUCT_HAMMER_SMASH: (Internal.SpawnParticleEffectMessage$ParticleTypes) & (Internal.SpawnParticleEffectMessage$ParticleTypes);
        static readonly MANAWEAVE_CRAFT_COMPLETE: (Internal.SpawnParticleEffectMessage$ParticleTypes) & (Internal.SpawnParticleEffectMessage$ParticleTypes);
        static readonly ENSORCELLATION_ITEM_PULL: (Internal.SpawnParticleEffectMessage$ParticleTypes) & (Internal.SpawnParticleEffectMessage$ParticleTypes);
    }
    type SpawnParticleEffectMessage$ParticleTypes_ = "manaweave_craft_complete" | SpawnParticleEffectMessage$ParticleTypes | "construct_axe_smash" | "construct_hammer_smash" | "ensorcellation_item_pull";
    ...
    class MultiblockDefinition extends Internal.AMRecipeBase implements Internal.IMultiblockDefinition {
        ...
        matchWithCount(arg0: Internal.Level_, arg1: BlockPos_, arg2: Internal.Rotation_, arg3: boolean): com.mojang.datafixers.util.Pair<number, number>;
        wait(): void;
    ...
    class MachineLocation$Loader extends Internal.Enum<Internal.MachineLocation$Loader> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        toString(): string;
        static valueOf(name: string): Internal.MachineLocation$Loader;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.MachineLocation$Loader>>;
        notifyAll(): void;
        compareTo(arg0: Internal.MachineLocation$Loader_): number;
        getDeclaringClass(): typeof Internal.MachineLocation$Loader;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        static values(): Internal.MachineLocation$Loader[];
        name(): string;
        hashCode(): number;
        getTranslatedName(): Internal.MutableComponent;
        ordinal(): number;
        wait(): void;
        "compareTo(fr.frinn.custommachinery.common.machine.MachineLocation$Loader)"(arg0: Internal.MachineLocation$Loader_): number;
        wait(arg0: number): void;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        get class(): typeof any
        get declaringClass(): typeof Internal.MachineLocation$Loader
        get translatedName(): Internal.MutableComponent
        static readonly KUBEJS: (Internal.MachineLocation$Loader) & (Internal.MachineLocation$Loader);
        static readonly DEFAULT: (Internal.MachineLocation$Loader) & (Internal.MachineLocation$Loader);
        static readonly DATAPACK_ZIP: (Internal.MachineLocation$Loader) & (Internal.MachineLocation$Loader);
        static readonly DATAPACK: (Internal.MachineLocation$Loader) & (Internal.MachineLocation$Loader);
        static readonly CODEC: Internal.NamedCodec<Internal.MachineLocation$Loader>;
        static readonly KUBEJS_SCRIPT: (Internal.MachineLocation$Loader) & (Internal.MachineLocation$Loader);
    }
    type MachineLocation$Loader_ = "datapack" | "kubejs" | "datapack_zip" | MachineLocation$Loader | "default" | "kubejs_script";
    ...
    abstract class WaterloggableBlockWithOffset extends Internal.WaterloggableBlock implements Internal.IOffsetPlace {
        constructor(arg0: Internal.BlockBehaviour$Properties_, arg1: boolean, ...arg2: BlockPos_[])
        /**
         * @deprecated
        */
        getSignal(arg0: Internal.BlockState_, arg1: Internal.BlockGetter_, arg2: BlockPos_, arg3: Internal.Direction_): number;
    ...
    type WaterloggableBlockWithOffset_ = WaterloggableBlockWithOffset;
    ...
    class RibbonParticleData extends Internal.AdvancedParticleData {
        constructor(arg0: Internal.ParticleType_<Internal.RibbonParticleData>, arg1: Internal.ParticleRotation_, arg2: number, arg3: number, arg4: number, arg5: number, arg6: number, arg7: number, arg8: number, arg9: boolean, arg10: number, arg11: any_[])
        constructor(arg0: Internal.ParticleType_<Internal.RibbonParticleData>, arg1: Internal.ParticleRotation_, arg2: number, arg3: number, arg4: number, arg5: number, arg6: number, arg7: number, arg8: number, arg9: boolean, arg10: number)
        getClass(): typeof any;
        getComponents(): any[];
        isEmissive(): boolean;
        getRed(): number;
        ...
        hashCode(): number;
        static CODEC_RIBBON(arg0: Internal.ParticleType_<Internal.RibbonParticleData>): Internal.Codec<Internal.RibbonParticleData>;
        wait(): void;
        ...
        get alpha(): number
        static readonly DESERIALIZER: Internal.ParticleOptions$Deserializer<Internal.RibbonParticleData>;
    }
    type RibbonParticleData_ = RibbonParticleData;
    ...
    class PickupTweakerTool extends Internal.TweakerTool {
        constructor(arg0: Internal.Item$Properties_)
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
    ...
    type PickupTweakerTool_ = PickupTweakerTool;
