...
declare namespace com.mojang.serialization.codecs {
...
declare namespace Internal {
    class CapabilityForgeEnergy$ItemStorageBuilder extends Internal.CapabilityBuilderForge<Internal.ItemStack, Internal.IEnergyStorage> {
        constructor(capacity: number, canExtract: boolean, canReceive: boolean)
        getClass(): typeof any;
        getCapability(instance: Internal.ItemStack_): Internal.IEnergyStorage;
        toString(): string;
        notifyAll(): void;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        receiveRate(receiveRate: number): this;
        hashCode(): number;
        wait(): void;
        wait(arg0: number): void;
        extractRate(extractRate: number): this;
        side(direction: Internal.Direction_): Internal.CapabilityBuilder<Internal.ItemStack, Internal.IEnergyStorage, Internal.Capability<T>>;
        availableOn(isAvailable: Internal.BiPredicate_<Internal.ItemStack, Internal.Direction>): Internal.CapabilityBuilder<Internal.ItemStack, Internal.IEnergyStorage, Internal.Capability<T>>;
        equals(arg0: any): boolean;
        get class(): typeof any
    }
    type CapabilityForgeEnergy$ItemStorageBuilder_ = CapabilityForgeEnergy$ItemStorageBuilder;
    ...
    class Quality extends Internal.Enum<Internal.Quality> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.Quality>>;
        toString(): string;
        static values(): Internal.Quality[];
        notifyAll(): void;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        name(): string;
        static valueOf(arg0: string): Internal.Quality;
        hashCode(): number;
        "compareTo(de.joh.fnc.api.util.Quality)"(arg0: Internal.Quality_): number;
        compareTo(arg0: Internal.Quality_): number;
        getDeclaringClass(): typeof Internal.Quality;
        ordinal(): number;
        wait(): void;
        wait(arg0: number): void;
        ...
        equals(arg0: any): boolean;
        get class(): typeof any
        get declaringClass(): typeof Internal.Quality
        static readonly NEUTRAL: (Internal.Quality) & (Internal.Quality);
        static readonly GOOD: (Internal.Quality) & (Internal.Quality);
        static readonly VERY_GOOD: (Internal.Quality) & (Internal.Quality);
        static readonly VERY_BAD: (Internal.Quality) & (Internal.Quality);
        static readonly BAD: (Internal.Quality) & (Internal.Quality);
    }
    type Quality_ = "neutral" | "bad" | "very_good" | Quality | "good" | "very_bad";
    ...
    class ModBlockProperties$BlockAttachment extends Internal.Enum<Internal.ModBlockProperties$BlockAttachment> implements Internal.StringRepresentable {
        ...
        "compareTo(net.mehvahdjukaar.amendments.reg.ModBlockProperties$BlockAttachment)"(arg0: Internal.ModBlockProperties$BlockAttachment_): number;
        getName(): string;
        compareTo(arg0: Internal.ModBlockProperties$BlockAttachment_): number;
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        toString(): string;
        notifyAll(): void;
        name(): string;
        ...
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.ModBlockProperties$BlockAttachment>>;
        ordinal(): number;
        wait(): void;
        getDeclaringClass(): typeof Internal.ModBlockProperties$BlockAttachment;
        wait(arg0: number): void;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        get class(): typeof any
        ...
        get name(): string
        get declaringClass(): typeof Internal.ModBlockProperties$BlockAttachment
        static readonly STICK: (Internal.ModBlockProperties$BlockAttachment) & (Internal.ModBlockProperties$BlockAttachment);
        static readonly BEAM: (Internal.ModBlockProperties$BlockAttachment) & (Internal.ModBlockProperties$BlockAttachment);
        static readonly BLOCK: (Internal.ModBlockProperties$BlockAttachment) & (Internal.ModBlockProperties$BlockAttachment);
        static readonly WALL: (Internal.ModBlockProperties$BlockAttachment) & (Internal.ModBlockProperties$BlockAttachment);
        static readonly PALISADE: (Internal.ModBlockProperties$BlockAttachment) & (Internal.ModBlockProperties$BlockAttachment);
        static readonly POST: (Internal.ModBlockProperties$BlockAttachment) & (Internal.ModBlockProperties$BlockAttachment);
    }
    ...
    class EffectBriarthornBarrier extends Internal.EffectWithCustomClientParticles implements Internal.INoCreeperLingering {
        constructor()
    ...
    type EffectBriarthornBarrier_ = EffectBriarthornBarrier;
    class ItemRuneMarking extends Internal.ItemRune implements Internal.IPositionalItem<Internal.ItemRuneMarking> {
        constructor()
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
    ...
    type ItemRuneMarking_ = ItemRuneMarking;
    class PonderElement {
        constructor()
        getClass(): typeof any;
    ...
    class ItemRecipeCopyBook$Modes extends Internal.Enum<Internal.ItemRecipeCopyBook$Modes> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        static values(): Internal.ItemRecipeCopyBook$Modes[];
        toString(): string;
        notifyAll(): void;
        compareTo(arg0: Internal.ItemRecipeCopyBook$Modes_): number;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.ItemRecipeCopyBook$Modes>>;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        getDeclaringClass(): typeof Internal.ItemRecipeCopyBook$Modes;
        name(): string;
        hashCode(): number;
        ordinal(): number;
        wait(): void;
        wait(arg0: number): void;
        static valueOf(arg0: string): Internal.ItemRecipeCopyBook$Modes;
        "compareTo(com.mna.items.artifice.ItemRecipeCopyBook$Modes)"(arg0: Internal.ItemRecipeCopyBook$Modes_): number;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        get class(): typeof any
        get declaringClass(): typeof Internal.ItemRecipeCopyBook$Modes
        static readonly COPY: (Internal.ItemRecipeCopyBook$Modes) & (Internal.ItemRecipeCopyBook$Modes);
        static readonly PASTE: (Internal.ItemRecipeCopyBook$Modes) & (Internal.ItemRecipeCopyBook$Modes);
    }
    type ItemRecipeCopyBook$Modes_ = ItemRecipeCopyBook$Modes | "copy" | "paste";
    ...
    abstract class PathfinderMobBuilder <T extends Internal.PathfinderMob & Internal.IAnimatableJS> extends Internal.MobBuilder<T> {
         ...
         * ```
        */
        meleeAttackRangeSqr(meleeAttackRangeSqr: Internal.Function_<Internal.Mob, any>): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        myRidingOffset(myRidingOffset: Internal.Function_<Internal.LivingEntity, any>): Internal.MobBuilder<T>;
        /**
         ...
         * ```
        */
        canPickUpLoot(canPickUpLoot: Internal.Function_<Internal.Mob, any>): Internal.MobBuilder<T>;
        /**
        ...
        */
        noEggItem(): Internal.MobBuilder<T>;
        /**
         ...
         * ```
        */
        removeWhenFarAway(removeWhenFarAway: Internal.Function_<Internal.ContextUtils$EntityDistanceToPlayerContext, any>): Internal.MobBuilder<T>;
        /**
        ...
        */
        eggItem(eggItem: Internal.Consumer_<Internal.SpawnEggItemBuilder>): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        canFireProjectileWeaponPredicate(canFireProjectileWeaponPredicate: Internal.Function_<Internal.ContextUtils$EntityProjectileWeaponContext, any>): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        createNavigation(createNavigation: Internal.Function_<Internal.ContextUtils$EntityLevelContext, any>): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        setAmbientSound(ambientSound: any): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        canJump(canJump: boolean): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        shouldDespawnInPeaceful(shouldDespawnInPeaceful: boolean): Internal.MobBuilder<T>;
        wait(): void;
        /**
        ...
        */
         ...
         * ```
        */
        canHoldItem(canHoldItem: Internal.Function_<Internal.ContextUtils$EntityItemStackContext, any>): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        isPersistenceRequired(isPersistenceRequired: boolean): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        tickLeash(consumer: Internal.Consumer_<Internal.ContextUtils$PlayerEntityContext>): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        ate(ate: Internal.Consumer_<Internal.LivingEntity>): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        canBeLeashed(canBeLeashed: Internal.Function_<Internal.ContextUtils$PlayerEntityContext, any>): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        ambientSoundInterval(ambientSoundInterval: number): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        canFireProjectileWeapon(canFireProjectileWeapon: Internal.Ingredient_): Internal.MobBuilder<T>;
        /**
        ...
        */
         ...
         * ```
        */
        onTargetChanged(setTarget: Internal.Consumer_<Internal.ContextUtils$TargetChangeContext>): Internal.MobBuilder<T>;
        equals(arg0: any): boolean;
    ...
    class DynamicBEEventJS extends Internal.DynamicAttachEventJS<Internal.BlockEntity> {
        constructor()
        getClass(): typeof any;
        /**
        ...
        */
        ...
        notify(): void;
        wait(arg0: number, arg1: number): void;
        add(predicate: Internal.Predicate_<Internal.BlockEntity>, provider: Internal.CapabilityBuilderForge_<Internal.BlockEntity, any>): Internal.DynamicAttachEventJS<Internal.BlockEntity>;
        /**
         * Stops the event with the given exit value. Execution will be stopped **immediately**.
         * 
    ...
    type DynamicBEEventJS_ = DynamicBEEventJS;
    ...
    class RegisterRecipeCatalystsEventJS extends Internal.JEIEventJS {
        constructor(data: Internal.IRecipeCatalystRegistration_)
    ...
    class ClientPacketListener implements Internal.ClientGamePacketListener, Internal.GetServerConfig, Internal.TickablePacketListener {
        ...
        handler$bhl003$onCustomPayload(packet: Internal.ClientboundCustomPayloadPacket_, ci: Internal.CallbackInfo_): void;
        ...
        fabrication$getServerTrileanConfig(): Internal.Map<any, any>;
        handleLogin(arg0: Internal.ClientboundLoginPacket_): void;
        handleTagQueryPacket(arg0: Internal.ClientboundTagQueryPacket_): void;
        handler$bfp002$onCustomPayload(packet: Internal.ClientboundCustomPayloadPacket_, ci: Internal.CallbackInfo_): void;
        handler$bfp001$onGameJoin(packet: Internal.ClientboundLoginPacket_, ci: Internal.CallbackInfo_): void;
        ...
        fabrication$getLaunchId(): number;
        ...
        fabrication$getServerStringConfig(): Internal.Map<any, any>;
        ...
        handler$djc000$handleBlockUpdateFTBC(packet: Internal.ClientboundBlockUpdatePacket_, ci: Internal.CallbackInfo_): void;
        ...
        handler$bde000$onGameJoin(packet: Internal.ClientboundLoginPacket_, ci: Internal.CallbackInfo_): void;
        ...
        handler$djc000$handleLevelChunkFTBC(packet: Internal.ClientboundLevelChunkWithLightPacket_, ci: Internal.CallbackInfo_): void;
        ...
        handler$edj000$mna$handleRemoveMobEffect(arg0: Internal.ClientboundRemoveMobEffectPacket_, arg1: Internal.CallbackInfo_): void;
        ...
        fabrication$getServerBanned(): Internal.Set<any>;
        tick(): void;
        handler$djc000$handleChunkBlocksUpdateFTBC(packet: Internal.ClientboundSectionBlocksUpdatePacket_, ci: Internal.CallbackInfo_): void;
        ...
        handler$bbp000$onCustomPayload(packet: Internal.ClientboundCustomPayloadPacket_, ci: Internal.CallbackInfo_): void;
        ...
        fabrication$getServerFailedConfig(): Internal.Map<any, any>;
        handleGameEvent(arg0: Internal.ClientboundGameEventPacket_): void;
        isAcceptingMessages(): boolean;
        handler$edj000$mna$handleUpdateMobEffect(arg0: Internal.ClientboundUpdateMobEffectPacket_, arg1: Internal.CallbackInfo_): void;
        ...
        hashCode(): number;
        handler$bde001$onCustomPayload(packet: Internal.ClientboundCustomPayloadPacket_, ci: Internal.CallbackInfo_): void;
    ...
    interface WasShoved {
        abstract fabrication$wasShoved(): boolean;
        (): boolean;
    }
    type WasShoved_ = WasShoved | (()=> boolean);
    ...
    class ElementalResistanceEnchantment$Type extends Internal.Enum<Internal.ElementalResistanceEnchantment$Type> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.ElementalResistanceEnchantment$Type>>;
        static valueOf(arg0: string): Internal.ElementalResistanceEnchantment$Type;
        toString(): string;
        static values(): Internal.ElementalResistanceEnchantment$Type[];
        notifyAll(): void;
        getDeclaringClass(): typeof Internal.ElementalResistanceEnchantment$Type;
        "compareTo(Tavi007.ElementalCombat.enchantments.ElementalResistanceEnchantment$Type)"(arg0: Internal.ElementalResistanceEnchantment$Type_): number;
        ...
        name(): string;
        hashCode(): number;
        compareTo(arg0: Internal.ElementalResistanceEnchantment$Type_): number;
        ...
        equals(arg0: any): boolean;
        get class(): typeof any
        get declaringClass(): typeof Internal.ElementalResistanceEnchantment$Type
        get enchantIncreasePerLevel(): number
        get minimalEnchantability(): number
        static readonly ICE: (Internal.ElementalResistanceEnchantment$Type) & (Internal.ElementalResistanceEnchantment$Type);
        static readonly LIGHT: (Internal.ElementalResistanceEnchantment$Type) & (Internal.ElementalResistanceEnchantment$Type);
        static readonly THUNDER: (Internal.ElementalResistanceEnchantment$Type) & (Internal.ElementalResistanceEnchantment$Type);
        static readonly DARKNESS: (Internal.ElementalResistanceEnchantment$Type) & (Internal.ElementalResistanceEnchantment$Type);
        static readonly WIND: (Internal.ElementalResistanceEnchantment$Type) & (Internal.ElementalResistanceEnchantment$Type);
        static readonly FIRE: (Internal.ElementalResistanceEnchantment$Type) & (Internal.ElementalResistanceEnchantment$Type);
        static readonly EARTH: (Internal.ElementalResistanceEnchantment$Type) & (Internal.ElementalResistanceEnchantment$Type);
        static readonly ELEMENT: (Internal.ElementalResistanceEnchantment$Type) & (Internal.ElementalResistanceEnchantment$Type);
        static readonly FLORA: (Internal.ElementalResistanceEnchantment$Type) & (Internal.ElementalResistanceEnchantment$Type);
        static readonly WATER: (Internal.ElementalResistanceEnchantment$Type) & (Internal.ElementalResistanceEnchantment$Type);
    }
    type ElementalResistanceEnchantment$Type_ = "earth" | "flora" | ElementalResistanceEnchantment$Type | "light" | "fire" | "ice" | "darkness" | "thunder" | "wind" | "water" | "element";
    ...
    abstract class Abstract_Cataclysm_Skull_Block extends Internal.BaseEntityBlock implements Internal.Equipable {
    ...
    type Abstract_Cataclysm_Skull_Block_ = Abstract_Cataclysm_Skull_Block;
    ...
    class InscriptionTableSetModifierMessage extends Internal.TileEntityServerMessage {
        constructor()
        constructor(arg0: BlockPos_, arg1: ResourceLocation_, arg2: number)
        getClass(): typeof any;
        ...
        notify(): void;
        wait(arg0: number, arg1: number): void;
        static decode(arg0: Internal.FriendlyByteBuf_): Internal.InscriptionTableSetModifierMessage;
        ...
        equals(arg0: any): boolean;
        static encode(arg0: Internal.InscriptionTableSetModifierMessage_, arg1: Internal.FriendlyByteBuf_): void;
        get class(): typeof any
    ...
    type InscriptionTableSetModifierMessage_ = InscriptionTableSetModifierMessage;
    ...
    class Node$StatementKind extends Internal.Enum<Internal.Node$StatementKind> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        toString(): string;
        notifyAll(): void;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        static valueOf(name: string): Internal.Node$StatementKind;
        compareTo(arg0: any): number;
        getType(): typeof Internal.Statement;
        name(): string;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.Node$StatementKind>>;
        hashCode(): number;
        "compareTo(icyllis.arc3d.compiler.tree.Node$StatementKind)"(arg0: Internal.Node$StatementKind_): number;
        ordinal(): number;
        wait(): void;
        static values(): Internal.Node$StatementKind[];
        wait(arg0: number): void;
        getDeclaringClass(): typeof Internal.Node$StatementKind;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        compareTo(arg0: Internal.Node$StatementKind_): number;
        get class(): typeof any
        get type(): typeof Internal.Statement
        get declaringClass(): typeof Internal.Node$StatementKind
        static readonly IF: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
        static readonly VARIABLE_DECL: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
        static readonly EXPRESSION: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
        static readonly SWITCH: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
        static readonly DISCARD: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
        static readonly CONTINUE: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
        static readonly BREAK: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
        static readonly BLOCK: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
        static readonly FOR_LOOP: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
        static readonly SWITCH_CASE: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
        static readonly EMPTY: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
        static readonly RETURN: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
        static readonly DO_LOOP: (Internal.Node$StatementKind) & (Internal.Node$StatementKind);
    }
    type Node$StatementKind_ = "break" | "variable_decl" | "block" | "expression" | "continue" | Node$StatementKind | "do_loop" | "switch" | "return" | "if" | "empty" | "for_loop" | "switch_case" | "discard";
    ...
    interface EmitParticlesInstruction$Emitter {
        paticleManager(): Internal.ParticleEngine;
        abstract create(arg0: Internal.PonderWorld_, arg1: number, arg2: number, arg3: number): void;
        withinBlockSpace<T extends Internal.ParticleOptions>(arg0: T, arg1: Vec3d_): this;
        simple<T extends Internal.ParticleOptions>(arg0: T, arg1: Vec3d_): this;
        (arg0: Internal.PonderWorld, arg1: number, arg2: number, arg3: number): void;
    }
    type EmitParticlesInstruction$Emitter_ = EmitParticlesInstruction$Emitter | ((arg0: Internal.PonderWorld, arg1: number, arg2: number, arg3: number)=> void);
    class VellumItem extends com.mna.api.items.TieredItem implements Internal.ICanContainSpell {
        constructor()
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
    ...
    type VellumItem_ = VellumItem;
    class CastingResourceRegistrationEvent extends net.minecraftforge.eventbus.api.Event {
        constructor()
        constructor(arg0: Internal.ICastingResourceRegistry_)
        getResult(): Internal.Event$Result;
        setCanceled(arg0: boolean): void;
        getClass(): typeof any;
        toString(): string;
        ...
        hashCode(): number;
        isCancelable(): boolean;
        getRegistry(): Internal.ICastingResourceRegistry;
        wait(): void;
        getListenerList(): Internal.ListenerList;
        wait(arg0: number): void;
        getPhase(): Internal.EventPriority;
        ...
        set result(arg0: Internal.Event$Result_)
        get cancelable(): boolean
        get registry(): Internal.ICastingResourceRegistry
        get listenerList(): Internal.ListenerList
        get phase(): Internal.EventPriority
    }
    type CastingResourceRegistrationEvent_ = CastingResourceRegistrationEvent;
    ...
    class WailaClientRegistrationEventJS extends Internal.EventJS {
        constructor(registration: any_)
        addConfig(key: ResourceLocation_, defaultValue: Internal.Enum_<any>): void;
        "addConfig(net.minecraft.resources.ResourceLocation,int,int,int,boolean)"(key: ResourceLocation_, defaultValue: number, min: number, max: number, slider: boolean): void;
        getAccessorHandler(clazz: Internal.Accessor<any>): Internal.Accessor$ClientHandler<Internal.Accessor<any>>;
        energyStorage(location: ResourceLocation_): Internal.ClientExtensionProviderBuilder<Internal.CompoundTag, Internal.EnergyView>;
        getServerData(): Internal.CompoundTag;
        markAsServerFeature(uid: ResourceLocation_): void;
        addRenderBackgroundCallback(priority: number, callback: Internal.JadeRenderBackgroundCallback_): void;
        notify(): void;
        hideTarget(entityType: Internal.EntityType_<any>): void;
        setServerData(tag: Internal.CompoundTag_): void;
        addItemModNameCallback(priority: number, callback: Internal.JadeItemModNameCallback_): void;
        addAfterRenderCallback(priority: number, callback: Internal.JadeAfterRenderCallback_): void;
        registerProgressClient(provider: Internal.IClientExtensionProvider_<Internal.CompoundTag, Internal.ProgressView>): void;
        registerBlockComponent(provider: Internal.IBlockComponentProvider_, block: typeof Internal.Block): void;
        markAsClientFeature(uid: ResourceLocation_): void;
        isServerConnected(): boolean;
        addItemModNameCallback(callback: Internal.JadeItemModNameCallback_): void;
        addAfterRenderCallback(callback: Internal.JadeAfterRenderCallback_): void;
        addRayTraceCallback(callback: Internal.JadeRayTraceCallback_): void;
        addConfig(key: ResourceLocation_, defaultValue: boolean): void;
        isClientFeature(uid: ResourceLocation_): boolean;
        entity(location: ResourceLocation_, entity: typeof Internal.Entity): Internal.EntityComponentProviderBuilder;
        "usePickedResult(net.minecraft.world.entity.EntityType)"(entityType: Internal.EntityType_<any>): void;
        "shouldPick(net.minecraft.world.level.block.state.BlockState)"(blockState: Internal.BlockState_): boolean;
        "shouldPick(net.minecraft.world.entity.Entity)"(entity: Internal.Entity_): boolean;
        "addConfig(net.minecraft.resources.ResourceLocation,boolean)"(key: ResourceLocation_, defaultValue: boolean): void;
        shouldHide(state: Internal.BlockState_): boolean;
        addConfig(key: ResourceLocation_, defaultValue: number, min: number, max: number, slider: boolean): void;
        hideTarget(block: Internal.Block_): void;
        "addConfig(net.minecraft.resources.ResourceLocation,java.lang.Enum)"(key: ResourceLocation_, defaultValue: Internal.Enum_<any>): void;
        registerEntityIcon(provider: Internal.IEntityComponentProvider_, entity: typeof Internal.Entity): void;
        block(location: ResourceLocation_, block: typeof Internal.Block): Internal.BlockComponentProviderBuilder;
        blockAccessor(): Internal.BlockAccessor$Builder;
        addRenderBackgroundCallback(callback: Internal.JadeRenderBackgroundCallback_): void;
        "shouldHide(net.minecraft.world.entity.Entity)"(target: Internal.Entity_): boolean;
        addBeforeRenderCallback(priority: number, callback: Internal.JadeBeforeRenderCallback_): void;
        itemStorage(location: ResourceLocation_): Internal.ClientExtensionProviderBuilder<Internal.ItemStack, Internal.ItemView>;
        addConfigListener(key: ResourceLocation_, listener: Internal.Consumer_<ResourceLocation>): void;
        registerBlockIcon(provider: Internal.IBlockComponentProvider_, block: typeof Internal.Block): void;
        getBlockCamouflage(level: Internal.LevelAccessor_, pos: BlockPos_): Internal.ItemStack;
        wait(): void;
        /**
         * Cancels the event with default exit value. Execution will be stopped **immediately**.
         * 
        ...
        */
        success(): any;
        entityAccessor(): Internal.EntityAccessor$Builder;
        getClass(): typeof any;
        /**
         * Stops the event with default exit value. Execution will be stopped **immediately**.
         * 
        ...
        */
        cancel(value: any): any;
        addConfig(key: ResourceLocation_, defaultValue: string, validator: Internal.Predicate_<string>): void;
        registerAccessorHandler<T extends Internal.Accessor<any>>(clazz: T, handler: Internal.Accessor$ClientHandler_<T>): void;
        addBeforeRenderCallback(callback: Internal.JadeBeforeRenderCallback_): void;
        "hideTarget(net.minecraft.world.entity.EntityType)"(entityType: Internal.EntityType_<any>): void;
        usePickedResult(entityType: Internal.EntityType_<any>): void;
        registerFluidStorageClient(provider: Internal.IClientExtensionProvider_<Internal.CompoundTag, Internal.FluidView>): void;
        wait(arg0: number, arg1: number): void;
        shouldPick(entity: Internal.Entity_): boolean;
        registerEnergyStorageClient(provider: Internal.IClientExtensionProvider_<Internal.CompoundTag, Internal.EnergyView>): void;
        "shouldHide(net.minecraft.world.level.block.state.BlockState)"(state: Internal.BlockState_): boolean;
        addConfig(key: ResourceLocation_, defaultValue: number, min: number, max: number, slider: boolean): void;
        progress(location: ResourceLocation_): Internal.ClientExtensionProviderBuilder<Internal.CompoundTag, Internal.ProgressView>;
        shouldHide(target: Internal.Entity_): boolean;
        registerCustomEnchantPower(block: Internal.Block_, customEnchantPower: Internal.CustomEnchantPower_): void;
        addTooltipCollectedCallback(priority: number, callback: Internal.JadeTooltipCollectedCallback_): void;
        usePickedResult(block: Internal.Block_): void;
        fluidStorage(location: ResourceLocation_): Internal.ClientExtensionProviderBuilder<Internal.CompoundTag, Internal.FluidView>;
        toString(): string;
        "addConfig(net.minecraft.resources.ResourceLocation,float,float,float,boolean)"(key: ResourceLocation_, defaultValue: number, min: number, max: number, slider: boolean): void;
        addRayTraceCallback(priority: number, callback: Internal.JadeRayTraceCallback_): void;
        addTooltipCollectedCallback(callback: Internal.JadeTooltipCollectedCallback_): void;
        notifyAll(): void;
        "hideTarget(net.minecraft.world.level.block.Block)"(block: Internal.Block_): void;
        registerItemStorageClient(provider: Internal.IClientExtensionProvider_<Internal.ItemStack, Internal.ItemView>): void;
        /**
         * Stops the event with the given exit value. Execution will be stopped **immediately**.
         * 
         * `exit` denotes a `default` outcome.
        */
        exit(value: any): any;
        shouldPick(blockState: Internal.BlockState_): boolean;
        createPluginConfigScreen(parent: Internal.Screen_, namespace: string): Internal.Screen;
        /**
         * Stops the event with the given exit value. Execution will be stopped **immediately**.
         * 
         * `success` denotes a `true` outcome.
        */
        ...
        hashCode(): number;
        wait(arg0: number): void;
        registerEntityComponent(provider: Internal.IEntityComponentProvider_, entity: typeof Internal.Entity): void;
        equals(arg0: any): boolean;
        "usePickedResult(net.minecraft.world.level.block.Block)"(block: Internal.Block_): void;
        maybeLowVisionUser(): boolean;
        get serverData(): Internal.CompoundTag
        set serverData(tag: Internal.CompoundTag_)
        get serverConnected(): boolean
        get class(): typeof any
        get showDetailsPressed(): boolean
    }
    type WailaClientRegistrationEventJS_ = WailaClientRegistrationEventJS;
    ...
    interface CapabilityCurios$ShouldDrop {
        abstract test(arg0: Internal.ItemStack_, arg1: Internal.SlotContext_, arg2: Internal.DamageSource_, arg3: number, arg4: boolean): boolean;
        (arg0: Internal.ItemStack, arg1: Internal.SlotContext, arg2: Internal.DamageSource, arg3: number, arg4: boolean): boolean;
    }
    type CapabilityCurios$ShouldDrop_ = ((arg0: Internal.ItemStack, arg1: Internal.SlotContext, arg2: Internal.DamageSource, arg3: number, arg4: boolean)=> boolean) | CapabilityCurios$ShouldDrop;
    ...
    interface IAdvancedRegistration {
        abstract getJeiFeatures(): Internal.IJeiFeatures;
        abstract addRecipeCategoryDecorator<T>(arg0: mezz.jei.api.recipe.RecipeType_<T>, arg1: Internal.IRecipeCategoryDecorator_<T>): void;
        abstract addRecipeManagerPlugin(arg0: Internal.IRecipeManagerPlugin_): void;
        abstract getJeiHelpers(): Internal.IJeiHelpers;
        get jeiFeatures(): Internal.IJeiFeatures
    ...
    class EntityType <T extends Internal.Entity> implements Internal.FeatureElement, Internal.InjectedEntityTypeExtension, Internal.EntityTypeTest<Internal.Entity, T>, Internal.EntityTypeExtension<any> {
        ...
        */
        ...
        arch$registryName(): ResourceLocation;
        handler$bbi000$spawnFromItemStack(world: Internal.ServerLevel_, stack: Internal.ItemStack_, player: Internal.Player_, pos: BlockPos_, reason: Internal.MobSpawnType_, alignPosition: boolean, invertY: boolean, ci: Internal.CallbackInfoReturnable_<any>): void;
    ...
    class Quest extends Internal.QuestObject implements Internal.IMixinQuest, Internal.Movable {
        ...
        getRawTitle(): string;
        handler$die000$readNetData(arg0: Internal.FriendlyByteBuf_, arg1: Internal.CallbackInfo_): void;
        ...
        handler$die000$isCompletedRaw(arg0: Internal.TeamData_, arg1: Internal.CallbackInfoReturnable_<any>): void;
        ...
        handler$die000$writeNetData(arg0: Internal.FriendlyByteBuf_, arg1: Internal.CallbackInfo_): void;
        ...
        handler$die000$getRelativeProgressFromChildren(arg0: Internal.TeamData_, arg1: Internal.CallbackInfoReturnable_<any>): void;
        wait(): void;
        ...
        handler$die000$isVisible(arg0: Internal.TeamData_, arg1: Internal.CallbackInfoReturnable_<any>): void;
        ...
        onCreated(): void;
        handler$die000$fillConfigGroup(arg0: Internal.ConfigGroup_, arg1: Internal.CallbackInfo_): void;
    ...
    class MobWardBlock extends Internal.BaseEntityBlock {
        ...
        */
        ...
        static readonly blockShape: (Internal.VoxelShapeSimpleCube) & (Internal.VoxelShape);
        static readonly thinBlockShape: (Internal.VoxelShapeAlignedCuboid) & (Internal.VoxelShape);
    }
    ...
    class IntegratedServer extends Internal.MinecraftServer {
        ...
        */
        ...
        localvar$deb000$wrapResourceManager(original: Internal.CloseableResourceManager_): Internal.CloseableResourceManager;
        ...
        getDisplayName(): net.minecraft.network.chat.Component;
        handler$bdi000$getPath(ci: Internal.CallbackInfo_): void;
