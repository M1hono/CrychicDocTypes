...
declare namespace TagEvent {
    ...
    class Sacrifice extends Internal.TagEventJS {
    get(id: Special.SacrificeTag): Internal.TagWrapper
    add(tag: Special.SacrificeTag, ...id: Special.Sacrifice[]): Internal.TagWrapper
    remove(tag: Special.SacrificeTag, ...id: Special.Sacrifice[]): Internal.TagWrapper
    removeAll(tag: Special.SacrificeTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.Sacrifice[]): Internal.TagWrapper
    }
