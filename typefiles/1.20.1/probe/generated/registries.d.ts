...
declare namespace Registry {
    ...
    class EntityType extends Internal.RegistryEventJS<any> {
        ...
        create(id: string): Internal.BaseEntityJSBuilder;
    }
    ...
    class Armorupgrade extends Internal.RegistryEventJS<any> {
    }
    class Spelladjustment extends Internal.RegistryEventJS<any> {
    }
    class Wildmagic extends Internal.RegistryEventJS<any> {
    }
    ...
    class Sacrifice extends Internal.RegistryEventJS<any> {
    }
