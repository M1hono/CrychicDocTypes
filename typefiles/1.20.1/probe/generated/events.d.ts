...
declare const AnimationJS: {
    /**
     * @at *client*
    */
playerRenderer(handler: (event: net.liopyu.animationjs.events.PlayerRenderer) => void):void,
    /**
     * @at *server*
    */
universalController(handler: (event: Internal.UniversalController) => void):void,
};
declare const RenderLevelEvents: {
    /**
     * Invoked after rendering the world.
     * 
     * @at *client*
    */
afterSolidBlockRender(handler: (event: Internal.RenderLevelEventJS$After) => void):void,
};
...
declare const RenderEntityEvents: {
    /**
     * Invoked before rendering a entity.
     * 
     * @at *client*
    */
beforeRender(handler: (event: Internal.RenderEntityEventJS$Before) => void):void,
    /**
     * Invoked after rendering a entity.
     * 
     * @at *client*
    */
afterRender(handler: (event: Internal.RenderEntityEventJS$After) => void):void,
};
...
registry(type: "dmnr:armorupgrade", handler: (event: Registry.Armorupgrade) => void):void,
registry(type: "fnc:spelladjustment", handler: (event: Registry.Spelladjustment) => void):void,
registry(type: "fnc:wildmagic", handler: (event: Registry.Wildmagic) => void):void,
...
registry(type: "every_mole:sacrifice", handler: (event: Registry.Sacrifice) => void):void,
